...
unsafe fn encls2(rax: u64, rbx: u64) -> (u32, u64) {
    ...
    asm!(
        "encls",
        in("rax") rax, in("rdi") rdi,
        lateout("eax") eax, lateout("rdi") rdi,
        options(nostack)
    );
    (eax, rdi)
}
...
unsafe fn encls3(rax: u64, rbx: u64, rcx: u64) -> (u32, u64) {
    ...
    asm!(
        "encls",
        in("rax") rax, in("rdi") rdi, in("rcx") rcx,
        lateout("eax") eax, lateout("rdi") rdi,
        options(nostack)
    );
    (eax, rdi)
...
unsafe fn encls4(rax: u64, rbx: u64, rcx: u64, rdx: u64) -> (u32, u64) {
    ...
    asm!(
        "encls",
        in("rax") rax, in("rdi") rdi, in("rcx") rcx, in("rdx") rdx,
        lateout("eax") eax, lateout("rdi") rdi,
        options(nostack)
    );
    (eax, rdi)
...
unsafe fn enclu3(rax: u64, rbx: u64, rcx: u64) -> (u32, u64) {
    ...
    asm!(
        "enclu",
        in("rax") rax, in("rdi") rbx, in("rcx") rcx,
...
unsafe fn enclu4(rax: u64, rbx: u64, rcx: u64, rdx: u64) -> (u32, u64) {
    ...
    asm!(
        "enclu",
        in("rax") rax, in("rdi") rbx, in("rcx") rcx, in("rdx") rdx,
        lateout("eax") eax, lateout("rcx") out_rcx,
        options(nostack)
    );
    (eax, out_rcx)
