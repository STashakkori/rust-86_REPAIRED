...
pub unsafe fn load_ss(sel: SegmentSelector) {
    ...
    //asm!("movw {0:x}, ss", in(reg) sel.bits(), options(nostack));
    asm!("mov {0}, ss", in(reg) sel.bits(), options(nostack));
}
...
pub unsafe fn load_ds(sel: SegmentSelector) {
    ...
    //asm!("movw {0:x}, ds", in(reg) sel.bits(), options(nostack));
    asm!("mov {0}, ds", in(reg) sel.bits(), options(nostack));
}
...
pub unsafe fn load_es(sel: SegmentSelector) {
    ...
    //asm!("movw {0:x}, es", in(reg) sel.bits(), options(nostack));
    asm!("mov {0}, es", in(reg) sel.bits(), options(nostack));
}
...
pub unsafe fn load_fs(sel: SegmentSelector) {
    ...
    //asm!("movw {0:x}, fs", in(reg) sel.bits(), options(nostack));
    asm!("mov {0}, fs", in(reg) sel.bits(), options(nostack));
}
...
pub unsafe fn load_gs(sel: SegmentSelector) {
    ...
    //asm!("movw {0:x}, gs", in(reg) sel.bits(), options(nostack));
    asm!("mov {0}, gs", in(reg) sel.bits(), options(nostack));
}
...
pub fn cs() -> SegmentSelector {
    ...
    unsafe { asm!("mov {}, cs", out(reg) segment); }
...
pub fn es() -> SegmentSelector {
    ...
    unsafe { asm!("mov {}, es", out(reg) segment); }
    SegmentSelector::from_raw(segment)
}
...
pub fn ss() -> SegmentSelector {
    ...
    unsafe { asm!("mov {}, ss", out(reg) segment); }
    SegmentSelector::from_raw(segment)
}
...
pub fn ds() -> SegmentSelector {
    ...
    unsafe { asm!("mov {}, ds", out(reg) segment); }
    SegmentSelector::from_raw(segment)
}
...
pub fn fs() -> SegmentSelector {
    ...
    unsafe { asm!("mov {}, fs", out(reg) segment); }
    SegmentSelector::from_raw(segment)
}
...
pub fn gs() -> SegmentSelector {
    ...
    //unsafe { asm!("movw {0:x}, gs", in(reg) sel.bits(), options(nostack)); }
    unsafe { asm!("mov {}, es", out(reg) segment); }
    SegmentSelector::from_raw(segment)
}
